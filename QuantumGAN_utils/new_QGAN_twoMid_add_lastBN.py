...
class QuantumGenerator(nn.Module):
    ...
    def forward(self, z):
        ...
        qcnn_stage_3_output_add_lastBN = self.BatchNorm2d_final_dim(qcnn_stage_3_output)


        # final_output: (batch_size, final_dim, final_size[0], final_size[1])
        final_output = self.Tanh(qcnn_stage_3_output_add_lastBN)



        return final_output, qcnn_stage_3_output, qcnn_stage_3_output_add_lastBN
